 ...
 * @author nafea8846
 */
public class SmooshBrosDuel_Dwarf extends JComponent implements ActionListener {
    ...
    boolean stretchRest = false;
    boolean up = false;
    Rectangle player = new Rectangle(40, 500, 50, 50);
    ...
    public void loop() {
        ...
        if (stretch) {
            if (crouch && !up) {
                if (player.height > 4 && player.height <= player.width) {
                ...
                if (player.width > 4 && player.width <= player.height) {
                    player.width--;
    ...
    public static void main(String[] args) {
        ...
        SmooshBrosDuel_Dwarf game = new SmooshBrosDuel_Dwarf();
    }
}
