 ...
 * @author nafea8846
 */
public class SmooshBrosDuel_Tall extends JComponent implements ActionListener {
    ...
    public void loop() {
        ...
        if (normalPunch) {
            if (punch.x < player.x - 50 || punch.x > player.x + player.width) {
                punch.x = player.x-50;
            }
            if (!crouch && !up) {
                punch.y = player.y + 25;
    ...
    public static void main(String[] args) {
        ...
        SmooshBrosDuel_Tall game = new SmooshBrosDuel_Tall();
    }
}
